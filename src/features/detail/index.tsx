...
import PokemonCatch from "../../component/PokemonCatch";
...
const PokemonDetail = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center p-20 m-20 text-black mx-auto bg-gray-100 min-h-screen">
      ...
      <PokemonCatch pokemon={pokemonDetail} />
    </div>
  );
};
